...
Принимаем на вход список, делаем из него множество, чтобы убрать повторяющиеся элементы, превращаем обратно в список, и снова сортируем, потому что множество не гарантиурет сортировку.
